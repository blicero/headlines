...
# Time-stamp: <2025-10-17 18:06:25 krylon>
#
...
** Clocktable
   ...
   #+CAPTION: Clock summary at [2025-10-17 Fr 18:06]
   | Headline                                 | Time       |            |       |      |
   |------------------------------------------+------------+------------+-------+------|
   | *Total time*                             | *1d 21:06* |            |       |      |
   |------------------------------------------+------------+------------+-------+------|
   | *Headlines [0/0]*                        | *1d 21:06* |            |       |      |
...
**** TODO Make links open in _blank
**** TODO Resize images
**** TODO Remove Javascript and such
*** Tagging [0/0]
    :PROPERTIES:
    :COOKIE_DATA: todo recursive
    :VISIBILITY: children
