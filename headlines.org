...
# Time-stamp: <2025-12-19 15:01:46 krylon>
#
...
** Clocktable
   ...
   #+CAPTION: Clock summary at [2025-12-19 Fr 15:01]
   | Headline                                        | Time      |            |          |         |       |      |
   |-------------------------------------------------+-----------+------------+----------+---------+-------+------|
   | *Total time*                                    | *6d 7:23* |            |          |         |       |      |
   |-------------------------------------------------+-----------+------------+----------+---------+-------+------|
   | *Headlines [40/43]*                             | *6d 7:23* |            |          |         |       |      |
   | \_  /Components [22/24]/                        |           | /4d 4:04/  |          |         |       |      |
   | \_    Common [1/1]                              |           |            |     0:08 |         |       |      |
   ...
   | \_    Main [0/0]                                |           |            |     1:53 |         |       |      |
   | \_  /Features [10/11]/                          |           | /1d 22:42/ |          |         |       |      |
   | \_    Later, B_tches [0/0]                      |           |            |     7:45 |         |       |      |
   | \_    Searching [1/1]                           |           |            |    18:17 |         |       |      |
   | \_      Search by time                          |           |            |          |    6:28 |       |      |
   ...
   | \_    More trouble with timestamps.             |           |            |     0:42 |         |       |      |
   | \_  /Journal [1/1]/                             |           | /0:26/     |          |         |       |      |
...
**** TODO Read-only connections?
     Seeing how often I open and close database connections, maybe I should
     make it possible to open a db connection read-only.
...
*** DONE Searching [1/1]
    CLOSED: [2025-12-04 Do 15:54]
    :LOGBOOK:
    CLOCK: [2025-12-02 Di 17:25]--[2025-12-02 Di 19:39] =>  2:14
    CLOCK: [2025-12-01 Mo 16:05]--[2025-12-01 Mo 21:02] =>  4:57
...
**** [2025-12-02 Di 19:39]
     After surprisingly little debugging, it /seems/ to work. But I have to
     torture it a little more, there's bound to be issues.
     Plus, I would like to do more with tags and especially with the tag
     hierarchy.
**** DONE Search by time
     CLOSED: [2025-12-04 Do 15:54]
     :LOGBOOK:
     CLOCK: [2025-12-04 Do 14:35]--[2025-12-04 Do 15:54] =>  1:19
     CLOCK: [2025-12-03 Mi 13:57]--[2025-12-03 Mi 17:46] =>  3:49
     CLOCK: [2025-12-02 Di 21:33]--[2025-12-02 Di 22:53] =>  1:20
     :END:
     Seems obvious, shouldn't be hard to implement.
*** DONE Blacklist [0/0]
...
*** DONE Deadlock in Cache layer
    ...
    :END:
*** DONE More trouble with timestamps.
    CLOSED: [2025-12-19 Fr 15:01]
    :LOGBOOK:
    CLOCK: [2025-12-18 Do 21:35]--[2025-12-18 Do 22:03] =>  0:28
    CLOCK: [2025-12-18 Do 21:09]--[2025-12-18 Do 21:23] =>  0:14
    :END:
    Says the log file:
    ValueError: time data '2025-12-17T21:35:00.117000+00:00' does not match
    format '%Y-%m-%dT%H:%M:%S%z'
    ...
    I think I need to snip off the "+00:00" at the end.
    ...
