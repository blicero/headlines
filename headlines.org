...
# Time-stamp: <2025-11-11 21:59:54 krylon>
#
...
** Clocktable
   ...
   #+CAPTION: Clock summary at [2025-11-11 Di 21:59]
   | Headline                                        | Time      |           |         |         |       |      |
   |-------------------------------------------------+-----------+-----------+---------+---------+-------+------|
   | *Total time*                                    | *4d 8:37* |           |         |         |       |      |
   |-------------------------------------------------+-----------+-----------+---------+---------+-------+------|
   | *Headlines [28/32]*                             | *4d 8:37* |           |         |         |       |      |
   | \_  /Components [15/17]/                        |           | /3d 3:44/ |         |         |       |      |
   | \_    Common [1/1]                              |           |           |    0:08 |         |       |      |
   ...
   | \_      Testing                                 |           |           |         |    0:50 |       |      |
   | \_    Engine [0/0]                              |           |           |   11:36 |         |       |      |
   | \_    Web UI [10/12]                            |           |           | 2d 1:27 |         |       |      |
   | \_      Manage feeds from WebUI [0/0]           |           |           |         |    0:52 |       |      |
...
*** Web UI [10/12]
    ...
    :END:
**** TODO Manage feeds from WebUI [0/0]
     :PROPERTIES:
     :COOKIE_DATA: todo recursive
     :VISIBILITY: children
     :END:
